...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        good_hit_list = pygame.sprite.spritecollide(self, self.level.item_list, False)
        bad_hit_list = pygame.sprite.spritecollide(self, self.level.letter_list, False)
        ...
        for good_item in good_hit_list:
            ...
            if self.change_x > 0 or self.change_x < 0 or self.change_y > 0 or self.change_y < 0:
                self.mixer.play_fx("lifeup")

                self.level.item_list.remove(good_item)
                self.score+=1
                print(self.score)
        ...
        for bad_item in bad_hit_list:
            ...
            if self.change_x > 0 or self.change_x < 0 or self.change_y > 0 or self.change_y < 0:
                ...
                self.level.letter_list.remove(bad_item)
                self.error1+=1
