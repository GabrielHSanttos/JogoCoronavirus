...
P1_PLATFORM_LEFT   = (432, 720, 70, 40)
P1_PLATFORM_MIDDLE = (648, 648, 70, 40)
P1_PLATFORM_RIGHT  = (792, 648, 70, 40)
THIN_P1            = (575, 432, 70, 70)



#PHASE2
P2_LEFT            = (360, 720, 70, 70)
P2_RIGHT           = (360, 576, 70, 70)
P2_MIDDLE          = (287, 576, 70, 70)
P2_PLATFORM_LEFT   = (722, 720, 70, 40)
P2_PLATFORM_MIDDLE = (720, 290, 70, 40)
P2_PLATFORM_RIGHT  = (722, 576, 70, 40)

#PHASE3
P3_LEFT = (287, 0, 80, 70)
P3_MIDDLE = (144, 792, 70, 70)
P3_RIGHT = (217, 792, 70, 70)

P3_PLATFORM_LEFT   = (215, 430, 70, 40)
P3_PLATFORM_MIDDLE = (218, 505, 70, 40)
P3_PLATFORM_RIGHT  = (218, 435, 70, 40)
P3_BLOCK  = (720, 865, 70, 70)
P3_SMALL_PLATAFORM  = (218, 505, 40, 40)
