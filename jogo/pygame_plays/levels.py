...
class Level_01(Level):
    ...
    def __init__(self, player):
        ...
        level = [ [platforms.INVISIBLE_BARRIER, 45, 300],
                  ...
                  [platforms.P1_LEFT, 450, 500],
                  [platforms.P1_MIDDLE, 520, 500],
                  [platforms.P1_RIGHT, 590, 500],
                  [platforms.P1_LEFT, 800, 400],
                  [platforms.P1_MIDDLE, 870, 400],
                  [platforms.P1_RIGHT, 940, 400],
                  [platforms.P1_LEFT, 1000, 500],
                  [platforms.P1_MIDDLE, 1070, 500],
                  [platforms.P1_RIGHT, 1140, 500],
                  [platforms.P1_PLATFORM_LEFT, 1120, 280],
                  [platforms.P1_PLATFORM_MIDDLE, 1190, 280],
                  [platforms.P1_PLATFORM_RIGHT, 1260, 280],

                  [platforms.THIN_P1, 2380, 550],
                  [platforms.THIN_P1, 2460, 500],
                  [platforms.THIN_P1, 2540, 450],
                  [platforms.THIN_P1, 2700, 570],

                  [platforms.EARTH, 2770, 530],
                  [platforms.EARTH, 2770, 470],
                  [platforms.P1_MIDDLE, 2770, 410],
                  [platforms.EXIT_SIGN, 3622, 530],

                  ]

        good_list = [[vacina.vacina, 515, 420],
        ...
        bad_list = [[virus1.virus1, 800, 100],
        ...
        for good_items in good_list:
            block = gel.Good_item(good_items[0])
            block.rect.x = good_items[1]
            block.rect.y = good_items[2]
            block.player = self.player
            self.item_list.add(block)

        for bad_items in bad_list:
            block = virus1.Bad_item(bad_items[0])
            block.rect.x = bad_items[1]
            block.rect.y = bad_items[2]
            block.player = self.player
            self.letter_list.add(block)

        # Add a custom moving platform

        block = platforms.MovingPlatform(platforms.P1_PLATFORM_MIDDLE)
        block.rect.x = 1350
        block.rect.y = 280
...
class Level_02(Level):
    ...
    def __init__(self, player):
        ...
        level = [ [platforms.INVISIBLE_BARRIER, 45, 200],
                  ...
                  [platforms.P2_PLATFORM_MIDDLE, 300, 400],
                  [platforms.P2_PLATFORM_LEFT, 500, 560],
                  [platforms.P2_PLATFORM_MIDDLE, 567, 520],
                  [platforms.P2_PLATFORM_RIGHT, 635, 480],
                  [platforms.P2_LEFT, 800, 400],
                  [platforms.P2_MIDDLE, 869, 400],
                  [platforms.P2_RIGHT, 939, 400],
                  [platforms.P2_LEFT, 1010, 500],
                  [platforms.P2_MIDDLE, 1069, 500],
                  [platforms.P2_RIGHT, 1139, 500],

                  [platforms.P2_LEFT, 1625, 280],
                  [platforms.P2_MIDDLE, 1690, 280],
                  [platforms.P2_RIGHT, 1760, 280],

                #stairs
                  [platforms.P2_PLATFORM_LEFT, 1925, 280],
                  [platforms.P2_PLATFORM_MIDDLE, 1990, 320],
                  [platforms.P2_PLATFORM_RIGHT, 2060, 360],
                  [platforms.P2_PLATFORM_LEFT, 2125, 400],
                  [platforms.P2_PLATFORM_MIDDLE, 2193, 440],
                  [platforms.P2_PLATFORM_RIGHT, 2260, 480],
                  [platforms.P2_PLATFORM_MIDDLE, 2320, 520],
                  [platforms.P2_PLATFORM_RIGHT, 2375, 560],

                  [platforms.EARTH, 2770, 530],
                  [platforms.EARTH, 2770, 470],
                  [platforms.EARTH, 2770, 410],
                  [platforms.EARTH, 2770, 350],
                  [platforms.P2_MIDDLE, 2770, 290],
                  [platforms.EXIT_SIGN, 3622, 530],
                  ]
        ...
        # Add a custom moving platform
        block = platforms.MovingPlatform(platforms.P2_PLATFORM_MIDDLE)
        block.rect.x = 1500
        block.rect.y = 300
        ...
        block1 = platforms.MovingPlatform(platforms.P2_PLATFORM_MIDDLE)
        block1.rect.x = 1300
        block1.rect.y = 200
        ...
        block3 = platforms.MovingPlatform(platforms.P2_PLATFORM_MIDDLE)
        block3.rect.x = 2700
        block3.rect.y = 300
