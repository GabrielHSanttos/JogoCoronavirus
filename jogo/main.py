...
# Gabriel Henrique dos Santos - TIA: 31816428
# Leonardo Cozzi Foleto - TIA: 31825826
# Sandra Pereira Costa - TIA: 31747515
...
class Mixer:
    ...
    def __init__(self, has_soundcard=False, volume = False):
        ...
        pygame.mixer.music.load("sfx\som.wav")
        ...
        if has_soundcard:
            self.fx = {
                ...
                "lifeup": pygame.mixer.Sound("./sfx/lifeup.wav"),
